...
public class OtherDetailsEdit extends AppCompatActivity
{
            ...
            dialogWithEditTextFragment =
                    DialogWithEditTextFragment.newInstance
                            (
                                    getFragmentManager(),     // for the transaction bit
                                    "hihi",            // unique name for this dialog type
                                    "Itinerary Name",    // form caption
                                    "Itinerary Name",             // form message
                                    R.drawable.attachment,
    ...
    public void saveSchedule(View view)
    {
        try {
            ...
            if (action.equals("add")) {
                ...
                otherItem.holidayId = holidayId;
                otherItem.dayId = dayId;
                otherItem.attractionId = attractionId;
                otherItem.attractionAreaId = attractionAreaId;
                otherItem.scheduleId = scheduleItem.scheduleId;
                otherItem.bookingReference = txtBookingRef.getText().toString();
    ...
    private void ShowError(String argFunction, String argMessage)
    {
        myMessages.ShowError
                (
                        "Error in OtherDetailsEdit::" + argFunction,
                        argMessage
                );
    }
