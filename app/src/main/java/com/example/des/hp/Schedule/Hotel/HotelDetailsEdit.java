    ...
    public void saveSchedule(View view)
    {
        try
        {
            ...
            if(action.equals("add"))
            {
                ...
                scheduleItem.hotelItem.holidayId=holidayId;
                scheduleItem.hotelItem.dayId=dayId;
                scheduleItem.hotelItem.attractionId=attractionId;
                scheduleItem.hotelItem.attractionAreaId=attractionAreaId;
