...
class TableSchedule extends TableBase
{
    ...
    public boolean addScheduleItem(EventScheduleItem eventScheduleItem)
    {
        try
        {
            ...
            String lSql="INSERT INTO schedule " +
                    ...
                    "   schedName, schedPicture, url1, url2, url3, " +
                    "   startTimeKnown, startHour, " +
                    "   startMin, endTimeKnown, endHour, endMin, infoId, " +
                    "   noteId, galleryId) " +
                    " VALUES " +
                    "(" + eventScheduleItem.holidayId + "," +
                    eventScheduleItem.dayId + "," +
                    eventScheduleItem.attractionId + "," +
                    eventScheduleItem.attractionAreaId + "," +
                    eventScheduleItem.scheduleId + "," +
                    eventScheduleItem.sequenceNo + "," +
                    eventScheduleItem.schedType + "," +
                    MyQuotedString(eventScheduleItem.schedName) + "," +
                    MyQuotedString(eventScheduleItem.schedPicture) + "," +
                    MyQuotedString(eventScheduleItem.url1) + "," +
                    MyQuotedString(eventScheduleItem.url2) + "," +
                    MyQuotedString(eventScheduleItem.url3) + "," +
                    lStartTimeKnown + ", " +
                    eventScheduleItem.startHour + ", " +
                    eventScheduleItem.startMin + ", " +
                    lEndTimeKnown + ", " +
                    eventScheduleItem.endHour + ", " +
                    eventScheduleItem.endMin + ", " +
                    eventScheduleItem.infoId + ", " +
                    eventScheduleItem.noteId + ", " +
                    eventScheduleItem.galleryId +
                    ")";
    ...
    public boolean updateScheduleItem(EventScheduleItem eventScheduleItem)
    {
        try
        {
            ...
            lSQL="UPDATE schedule " +
                    "SET dayId = " + eventScheduleItem.dayId + ", " +
                    "    attractionId = " + eventScheduleItem.attractionId + ", " +
                    "    attractionAreaId = " + eventScheduleItem.attractionAreaId + ", " +
                    "    schedName = " + MyQuotedString(eventScheduleItem.schedName) + ", " +
                    "    schedPicture = " + MyQuotedString(eventScheduleItem.schedPicture) + ", " +
                    "    url1 = " + MyQuotedString(eventScheduleItem.url1) + ", " +
                    "    url2 = " + MyQuotedString(eventScheduleItem.url2) + ", " +
                    "    url3 = " + MyQuotedString(eventScheduleItem.url3) + ", " +
                    "    startTimeKnown = " + lStartTimeKnown + ", " +
                    "    startHour = " + eventScheduleItem.startHour + ", " +
                    "    startMin = " + eventScheduleItem.startMin + ", " +
                    "    endTimeKnown = " + lEndTimeKnown + ", " +
                    "    endHour = " + eventScheduleItem.endHour + ", " +
                    "    endMin = " + eventScheduleItem.endMin + ", " +
                    "    sequenceNo = " + eventScheduleItem.sequenceNo + ", " +
                    "    scheduleId = " + eventScheduleItem.scheduleId + ", " +
                    "    infoId = " + eventScheduleItem.infoId + ", " +
                    "    noteId = " + eventScheduleItem.noteId + ", " +
                    "    galleryId = " + eventScheduleItem.galleryId +
                    " WHERE holidayId = " + eventScheduleItem.holidayId + " " +
                    "AND dayId = " + eventScheduleItem.origDayId + " " +
                    "AND attractionId = " + eventScheduleItem.origAttractionId + " " +
                    "AND attractionAreaId = " + eventScheduleItem.origAttractionAreaId + " " +
    ...
    boolean deleteScheduleItem(EventScheduleItem eventScheduleItem)
    {
        try
        {
            ...
            String lSQL="DELETE FROM schedule " +
                    "WHERE holidayId = " + eventScheduleItem.holidayId + " " +
                    "AND dayId = " + eventScheduleItem.dayId + " " +
                    "AND attractionId = " + eventScheduleItem.attractionId + " " +
                    "AND attractionAreaId = " + eventScheduleItem.attractionAreaId + " " +
                    "AND scheduleId = " + eventScheduleItem.scheduleId;
    ...
    private boolean GetScheduleItemFromQuery(Cursor cursor, EventScheduleItem eventScheduleItem)
    {
        ...
        try
        {
            ...
            eventScheduleItem.url1=cursor.getString(9);
            eventScheduleItem.url2=cursor.getString(10);
            eventScheduleItem.url3=cursor.getString(11);
            eventScheduleItem.startTimeKnown=Integer.parseInt(cursor.getString(12)) == 1;
            eventScheduleItem.startHour=Integer.parseInt(cursor.getString(13));
            eventScheduleItem.startMin=Integer.parseInt(cursor.getString(14));
            eventScheduleItem.endTimeKnown=Integer.parseInt(cursor.getString(15)) == 1;
            eventScheduleItem.endHour=Integer.parseInt(cursor.getString(16));
            eventScheduleItem.endMin=Integer.parseInt(cursor.getString(17));
            eventScheduleItem.infoId=Integer.parseInt(cursor.getString(18));
            eventScheduleItem.noteId=Integer.parseInt(cursor.getString(19));
            eventScheduleItem.galleryId=Integer.parseInt(cursor.getString(20));
            ...
            eventScheduleItem.origUrl1= eventScheduleItem.url1;
            eventScheduleItem.origUrl2= eventScheduleItem.url2;
            eventScheduleItem.origUrl3= eventScheduleItem.url3;
