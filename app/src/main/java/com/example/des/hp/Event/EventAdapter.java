...
public class EventAdapter extends RecyclerView.Adapter<EventAdapter.ViewHolder>
{
    ...
    public ArrayList<EventScheduleItem> data;
    ...
    {
        void onItemClick(View view, EventScheduleItem obj);
    }
    ...
    public EventAdapter(Activity activity, ArrayList<EventScheduleItem> items)
    {
    ...
    {
        final EventScheduleItem c=data.get(position);
        ...
        if(c.eventScheduleDetailItem != null)
        {
            EventScheduleDetailItem g = c.eventScheduleDetailItem;
    ...
    public EventScheduleItem getItem(int position)
    {
        return data.get(position);
    }

    public void add(int position, EventScheduleItem mail)
    {
    ...
    private void updateGlobalData(ArrayList<EventScheduleItem> items)
    {
