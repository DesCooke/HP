...
public class DatabaseAccess extends SQLiteOpenHelper
{
    ...
    public boolean createSampleDatabase()
    {
        ...
        if (!tableHoliday.createSample(myInt, false, false, false, false))
            return (false);
        if (!tableHoliday.createSample(myInt, false, false, false, true))
            return (false);
        if (!tableHoliday.createSample(myInt, false, false, true, false))
            return (false);
        if (!tableHoliday.createSample(myInt, false, false, true, true))
            return (false);
        if (!tableHoliday.createSample(myInt, false, true, false, false))
            return (false);
        if (!tableHoliday.createSample(myInt, false, true, false, true))
            return (false);
        if (!tableHoliday.createSample(myInt, false, true, true, false))
            return (false);
        if (!tableHoliday.createSample(myInt, false, true, true, true))
            return (false);
        if (!tableHoliday.createSample(myInt, true, false, false, false))
            return (false);
        if (!tableHoliday.createSample(myInt, true, false, false, true))
            return (false);
        if (!tableHoliday.createSample(myInt, true, false, true, false))
            return (false);
        if (!tableHoliday.createSample(myInt, true, false, true, true))
            return (false);
        if (!tableHoliday.createSample(myInt, true, true, false, false))
            return (false);
        if (!tableHoliday.createSample(myInt, true, true, false, true))
            return (false);
        if (!tableHoliday.createSample(myInt, true, true, true, false))
            return (false);
        if (!tableHoliday.createSample(myInt, true, true, true, true))
            return (false);
    ...
    public boolean createSampleNote(int holidayId, MyInt myInt)
    {
