...
public class ThemeParkAdapter extends RecyclerView.Adapter<ThemeParkAdapter.ViewHolder>
{
    ...
    public ArrayList<ThemeParkItem> data;
    ...
    {
        void onItemClick(View view, ThemeParkItem obj);
    }
    ...
    ThemeParkAdapter(Activity activity, ArrayList<ThemeParkItem> items)
    {
    ...
    @NonNull
    @Override
    public ThemeParkAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.themeparklistitemrow, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position)
    {
        ...
        final ThemeParkItem c = data.get(position);
    ...
    public ThemeParkItem getItem(int position)
    {
        return data.get(position);
    }
    
    public void add(int position, ThemeParkItem mail)
    {
    ...
    private void updateGlobalData(ArrayList<ThemeParkItem> items)
    {
