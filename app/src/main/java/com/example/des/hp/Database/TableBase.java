...
public class TableBase
{
    ...
    public String MyQuotedString(String argString)
    {
        ...
        String lQuotedString = "'" + lCleanString + "'";
        
        return (lQuotedString);
    }
    ...
    public int pictureUsageCount(String argFilename, String argTable, String argField)
    {
        int lCount = 0;
        String lSQL;
    ...
    public int totalUsageCount(String argFilename)
    {
        int lCount = 0;
    ...
    // returns true/false
    public boolean getNextFileId(String argType, MyInt retInt)
    {
        if (IsValid() == false)
            return (false);
    ...
    public boolean setNextFileId(String argType, int argNextFileId)
    {
        if (IsValid() == false)
            return (false);
