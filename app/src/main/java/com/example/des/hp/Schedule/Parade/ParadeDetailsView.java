...
public class ParadeDetailsView extends AppCompatActivity
{
    ...
    private void ShowError(String argFunction, String argMessage)
    {
        myMessages.ShowError
                (
                        "Error in ParadeDetailsView::" + argFunction,
                        argMessage
                );
    }
    ...
    public void editParade()
    {
        ...
        {
            ShowError("editParade", e.getMessage());
        }
    }
    ...
    public void deleteParade()
    {
        ...
        {
            ShowError("deleteParade", e.getMessage());
        }
    }
