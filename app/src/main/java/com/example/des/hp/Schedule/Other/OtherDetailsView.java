...
public class OtherDetailsView extends AppCompatActivity
{
    ...
    private void ShowError(String argFunction, String argMessage)
    {
        myMessages.ShowError
                (
                        "Error in OtherDetailsView::" + argFunction,
                        argMessage
                );
    }
    ...
    public void editOther()
    {
        ...
        {
            ShowError("editOther", e.getMessage());
        }
    }
    ...
    public void deleteOther()
    {
        ...
        {
            ShowError("deleteOther", e.getMessage());
        }
    }
