    ...
    public void saveSchedule(View view)
    {
        try
        {
            ...
            if(action.equals("add"))
            {
                ...
                scheduleItem.paradeItem.holidayId=holidayId;
                scheduleItem.paradeItem.dayId=dayId;
                scheduleItem.paradeItem.attractionId=attractionId;
                scheduleItem.paradeItem.attractionAreaId=attractionAreaId;
