...
public class ParadeDetailsEdit extends AppCompatActivity
{
            ...
            dialogWithEditTextFragment =
                    DialogWithEditTextFragment.newInstance
                            (
                                    ...
                                    "Parade Name",    // form caption
                                    "Parade Name",             // form message
    ...
    public void saveSchedule(View view)
    {
        try {
            ...
            if (action.equals("add")) {
                ...
                scheduleItem.schedType = getResources().getInteger(R.integer.schedule_type_parade);


                paradeItem.holidayId = holidayId;
                paradeItem.dayId = dayId;
                paradeItem.attractionId = attractionId;
                paradeItem.attractionAreaId = attractionAreaId;
                paradeItem.scheduleId = scheduleItem.scheduleId;
                paradeItem.bookingReference = txtBookingRef.getText().toString();

                scheduleItem.paradeItem = paradeItem;
            ...
            if (action.equals("edit")) {
                ...
                if (scheduleItem.paradeItem != null) {
                    scheduleItem.paradeItem.bookingReference = txtBookingRef.getText().toString();
                }
    ...
    private void ShowError(String argFunction, String argMessage)
    {
        myMessages.ShowError
                (
                        "Error in ParadeDetailsEdit::" + argFunction,
                        argMessage
                );
    }
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        try {
            setContentView(R.layout.activity_parade_details_edit);
