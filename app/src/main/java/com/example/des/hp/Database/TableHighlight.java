...
class TableHighlight extends TableBase
{
    ...
    public boolean onCreate(SQLiteDatabase db)
    {
        try
        {
            String lSQL="CREATE TABLE IF NOT EXISTS highlight " + "( " + "  holidayId        INT(5),  " + "  dayId            INT(5),  " + "  highlightGroupId INT(5),  " + "  highlightId      INT(5),  " + "  sequenceNo       INT(5),  " + "  highlightType    INT(5),  " + "  highlightName    VARCHAR, " + "  highlightPicture VARCHAR, " + "  infoId           INT(5),  " + "  noteId           INT(5),  " + "  galleryId        INT(5),  " + "  sygicId          INT(5)   " + ") ";
