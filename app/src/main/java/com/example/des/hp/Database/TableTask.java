...
class TableTask extends TableBase
{
    ...
    boolean addTaskItem(TaskItem taskItem)
    {
        ...
        String lSql = "INSERT INTO tasks " +
            "  (holidayId, taskId, sequenceNo, taskDescription, " +
            ...
            taskItem.taskId + "," +
            taskItem.sequenceNo + ", " +
            MyQuotedString(taskItem.taskDescription) + ", " +
            lTaskDateKnown + "," +
            taskItem.taskDateInt + "," +
            MyQuotedString(taskItem.taskPicture) + ", " +
            lTaskComplete + ", " +
            MyQuotedString(taskItem.taskNotes) + ", " +
            taskItem.infoId + ", " +
            taskItem.noteId + ", " +
            taskItem.galleryId + ", " +
            taskItem.sygicId + " " +
    ...
    boolean updateTaskItem(TaskItem taskItem)
    {
        ...
        {
            if (taskItem.origPictureAssigned && taskItem.taskPicture.length() > 0 &&
                taskItem.taskPicture.compareTo(taskItem.origTaskPicture) == 0)
            {
        ...
        String lSQL;
        lSQL = "UPDATE Tasks " +
            "SET sequenceNo = " + taskItem.sequenceNo + ", " +
            "    taskDescription = " + MyQuotedString(taskItem.taskDescription) + ", " +
            "    taskDateKnown = " + lDateKnown + ", " +
            "    taskDate = " + taskItem.taskDateInt + ", " +
            "    taskPicture = " + MyQuotedString(taskItem.taskPicture) + ", " +
            "    taskComplete = " + lTaskComplete + ", " +
            "    taskNotes = " + MyQuotedString(taskItem.taskNotes) + ", " +
            "    infoId = " + taskItem.infoId + ", " +
            "    noteId = " + taskItem.noteId + ", " +
            "    galleryId = " + taskItem.galleryId + ", " +
            "    sygicId = " + taskItem.sygicId + " " +
    ...
    boolean getTaskItem(int holidayId, int taskId, TaskItem taskItem)
    {
        ...
        String lSQL;
        lSQL = "SELECT holidayId, taskId, sequenceNo, taskDescription, " +
            "  taskDateKnown, taskDate, taskPicture, taskComplete, taskNotes, infoId, " +
            "  noteId, galleryId, sygicId " +
            "FROM Tasks " +
    ...
    {
        String lSQL = "SELECT IFNULL(MAX(taskId),0) " +
            "FROM Tasks " +
            "WHERE holidayId = " + holidayId;
